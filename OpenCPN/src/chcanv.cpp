...
void ChartCanvas::OnRolloverPopupTimerEvent( wxTimerEvent& event )
{
     ...
     */
    //if( (6.960065<m_cursor_lat && m_cursor_lat<6.960125) && (79.83920<m_cursor_lon && m_cursor_lon<79.83935) )
    if ((6.960020 < m_cursor_lat && m_cursor_lat < 6.960170) && (79.83920 < m_cursor_lon && m_cursor_lon < 79.83935))
    {
        ...
        {
            m_pAISRolloverWin->SetString(VTMCoordinators);
