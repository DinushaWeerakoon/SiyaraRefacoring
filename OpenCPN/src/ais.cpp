...
wxString VTMCoordinators = _T("New Pilot Station");
//--------------------------------------------------
...
static void AISDrawTarget( AIS_Target_Data *td, ocpnDC& dc )
{
    ...
    if( drawit ) {
        ...
        if( td->Class == AIS_ARPA ) {
            ...
            int ship_type_index = td->ShipType;
            wxString ship_type_color;
            switch (ship_type_index)
            {
                case 30: ship_type_color = _("BRWN"); break;   //Vessel Fishing
                case 50: ship_type_color = _("BLUE1"); break;   //Pilot Vessel
                case 52: ship_type_color = _("TGBL"); break;   //Tug
                case 31: //Vessel Towing
                case 32: //Vessel Towing, Long
                case 33: //Vessel Dredging
                case 34: //Vessel Diving
                case 35: //Military Vessel
                case 36: //Sailing Vessel
                case 37: //Pleasure craft
                case 51: //Search and Rescue Vessel
                case 53: //Port Tender
                case 54: //Pollution Control Vessel
                case 55: //Law Enforcement Vessel
                case 58: ship_type_color = _("PPLE"); break;   //Medical Transport
                default: ship_type_color = _("GREY1"); break;  //Unknown
            }
            if ((ship_type_index >= 40) && (ship_type_index < 50)) ship_type_color = _("YELO1");   //High Speed Craft
            else if ((ship_type_index >= 60) && (ship_type_index < 70)) ship_type_color = _("BLUE3");   //Passenger Ship
            else if ((ship_type_index >= 70) && (ship_type_index < 80)) ship_type_color = _("UGREN");   //Cargo Ship
            else if ((ship_type_index >= 80) && (ship_type_index < 90)) ship_type_color = _("URED");   //Tanker
            
            wxBrush target_brush = wxBrush(GetGlobalColor(ship_type_color));
